# Dupe Finder 0.1.1 preview

Portable Windows x64 preview with a native rename-buffer compatibility fix verified on the hosted Windows runner, built in C# with WinUI 3 / Windows App SDK 2.4.0.
